...
#define NL_EXPOSURE 1.37               // [toggle] 0.5 dark ~ 3.0 bright
...
#define NL_NIGHT_BRIGHTNESS -0.35	 // 0.0 dark ~ 2.0 bright
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(0.97, 0.6, 0.31)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.52,0.18)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.52,0.18)
#define NL_END_TORCH_COL        vec3(0.84,0.52,0.18)

/* Fog */
#define NL_FOG 0.7                // [toggle] 0.1 subtle ~ 1.0 blend with sky completely
...
#define NL_WATER_TINT vec3(0.0,0.09,0.54)
...
#define NL_UNDERWATER_TINT vec3(0.0,0.6,1.0) // fog tint color when underwater
...
#define NL_CLOUD2_DENSITY 45.0       // 1.0 blurry ~ 100.0 sharp
...
#define NL_SHOOTING_STAR_DELAY 2.5  // 0.0 no delay ~ 100.0 long time (100 secs)
...
#define NL_GODRAY 1.2 // [toggle] 1.0 subtle ~ 2.0 strong
